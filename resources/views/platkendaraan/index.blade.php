                                ...
                                <div class="bg-gray-50 p-6 rounded-lg border">
                                    ...
                                    <div class="space-y-2 mb-4">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="text-sm font-medium">{{ $kendaraan->bookingServices()->count() }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <a href="{{ route('platkendaraan.history', $kendaraan->id_plat_kendaraan) }}"
                                            class="flex-1 text-center px-3 py-2 text-sm bg-green-200 text-green-700 rounded hover:bg-green-300">
                                            History
                                        </a>

                                        <a href="{{ route('platkendaraan.edit', $kendaraan->id_plat_kendaraan) }}"
                                            class="flex-1 text-center px-3 py-2 text-sm bg-gray-200 text-gray-700 rounded hover:bg-gray-300">
                                            Edit
                                        </a>
                                        <form
                                            action="{{ route('platkendaraan.destroy', $kendaraan->id_plat_kendaraan) }}"
                                            method="POST" class="flex-1">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="w-full px-3 py-2 text-sm bg-red-200 text-red-700 rounded hover:bg-red-300"
