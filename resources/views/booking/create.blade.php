                ...
                <div class="p-6 lg:p-8">
                        ...
                        <form method="POST" action="{{ route('booking.store') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select id="id_plat_kendaraan" name="id_plat_kendaraan" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                        <option value="">-- Select Your Vehicle --</option>
                                        @foreach($userVehicles as $vehicle)
                                            <option value="{{ $vehicle->id_plat_kendaraan }}" {{ old('id_plat_kendaraan') == $vehicle->id_plat_kendaraan ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <x-input id="tanggal_booking" class="block mt-1 w-full" type="date" name="tanggal_booking" :value="old('tanggal_booking')" min="{{ date('Y-m-d', strtotime('+1 day')) }}" required />
                                ...
                                <div>
                                    ...
                                    <x-input id="estimasi_kedatangan" class="block mt-1 w-full" type="time" name="estimasi_kedatangan" :value="old('estimasi_kedatangan')" required />
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="keluhan_konsumen" name="keluhan_konsumen" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Tuliskan permasalahan kendaraanmu..." required>{{ old('keluhan_konsumen') }}</textarea>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Kamu harus melakukan login sebelum booking service.</p>
                            <div class="mt-6">
