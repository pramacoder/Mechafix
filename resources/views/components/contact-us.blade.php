            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-4">
                        ...
                        <button type="submit" :disabled="isSubmitting" class="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-orange-500 border-2 border-orange-500 font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed">
                            <span x-show="!isSubmitting">Send Message</span>
                            <span x-show="isSubmitting" class="flex items-center justify-center">
                                <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-orange-500 border-2 border-orange-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <div x-show="showSuccessModal" 
        ...
        <div class="bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl">
            ...
            <button @click="closeSuccessModal" 
                    class="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-orange-500 border-2 border-orange-500 font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02]">
                Got it!
            </button>
        </div>
    </div>
